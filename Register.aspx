<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="Exercise_5.Register" %>
<style>
...
<body>
    ...
    <div class="container">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Please fill in your password" EnableClientScript="False" ControlToValidate="pass" ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please fill in your address" EnableClientScript="False" ControlToValidate="address" ForeColor="Red"></asp:RequiredFieldValidator>
                ...
                <asp:TextBox ID="address" runat="server" placeholder="Address" CssClass="input" TextMode="MultiLine"></asp:TextBox>
				<br>
